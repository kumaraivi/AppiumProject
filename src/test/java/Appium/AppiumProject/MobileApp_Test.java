...
public class MobileApp_Test {
  ...
  public void KhanAcademy_Explore_Economy() throws InterruptedException
  {
	  ...
	  Thread.sleep(3000);
	  driver.findElement(AppiumBy.androidUIAutomator("UiSelector().text(\"Search\")")).sendKeys("Life Skills", Keys.ENTER);
	  Thread.sleep(8000);
	  //check whether page is displayed
	  String expected = "Life Skills";
	  String actual = driver.findElement(AppiumBy.androidUIAutomator("UiSelector().Life Skills\")")).getText();
